...
const HomeButtonWrapper = Styled.div<HomeButtonWrapperProps>`
  width: ${({ show }) => (show ? '30px' : '0')};
  height: ${({ show }) => (show ? '30px' : '0')};
...
const HomeButton: React.FC<HomeButton> = ({ show, onClick }: HomeButton) => {
  return (
    <HomeButtonWrapper show={show} onClick={onClick}>
